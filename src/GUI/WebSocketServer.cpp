...
WebSocketServer::WebSocketServer(boost::asio::io_service& io_service)
  ...
  server.set_message_handler(boost::bind(&WebSocketServer::on_message, this,
                                         boost::placeholders::_1, boost::placeholders::_2));
  server.set_close_handler(boost::bind(&WebSocketServer::on_close, this, boost::placeholders::_1));
  server.set_open_handler(boost::bind(&WebSocketServer::on_open, this, boost::placeholders::_1));
